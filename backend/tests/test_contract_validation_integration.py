...
def fake_cosmos():
    ...
    def list_activities(limit=100):
        return cosmos.activities[-limit:]
    ...
    cosmos.list_activities = list_activities
...
class TestValidationAPI:
    ...
    def test_contract_not_found_persists_error_activity(
        ...
        activities = fake_cosmos.list_activities()
...
class TestEvidenceBuilding:
    ...
    async def test_builds_complete_evidence_snapshot(
        self, fake_cosmos, monkeypatch_chain_cache, sample_contract
    ):
