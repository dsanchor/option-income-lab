...
class CosmosDBService:
    ...
    def get_recent_banner_activities(
        self,
        *,
        since: datetime,
        limit: int,
    ) -> list[dict]:
        """Return banner-eligible activities ordered by parsed UTC timestamp.

        Banner freshness cannot rely on Cosmos string ordering because legacy
        activity timestamps use multiple ISO representations. The SDK iterates
        every continuation page; filtering and ordering happen after parsing.
        """
